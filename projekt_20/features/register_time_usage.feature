Feature: Register time-usage
   ...
   Scenario: The employee adds hours for the days activities //Roi
  ...
  Scenario: The employee adds negative amount of hours for the days activities //Roi
    Given there exists an employee <2> who is assigned to the activity <1> in project "project 1"
    And employee <2> is the user
    When the employee <2> registers <-10> half hours worked on activity <1> in project "project 1" for the day
    Then the error message "Invalid input. Please insert a positive Integer..." is given
     
  Scenario: The employee adds too many hours for the days activities //Roi
    Given there exists an employee <2> who is assigned to the activity <1> in project "project 1"
    And employee <2> is the user
  ...
  Scenario: The employee removes hours from the weeks registry //Roi
    Given there exists an employee <2> who is assigned to the activity <1> in project "project 1"
    And employee <2> is the user
  ...
  Scenario: The employee removes more hours from the weeks registry than exist //Roi
    Given there exists an employee <2> who is assigned to the activity <1> in project "project 1"
    And employee <2> is the user
    And the employee <2> registers <10> half hours worked on activity <1> in project "project 1" for the day
  ...
  Scenario: Get activities that an employee is assigned to //Roi
